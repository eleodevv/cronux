#!/usr/bin/env python3
"""
Cronux-CRX GUI v0.1.1 - Interfaz gráfica con tipos de proyecto
...
# Tipos de proyecto con iconos y configuraciones
TIPOS_PROYECTO = {
    "general": {
        "nombre": "General",
        "icono": "icons/wordblanco.svg",
        "icono_negro": "icons/wordnegro.svg",
        "descripcion": "Proyecto sin configuración específica",
        "exclude": [],
        "install_cmd": None
    },
    "nodejs": {
        "nombre": "Node.js / JavaScript",
        "icono": "icons/nodeblanco.svg",
        "icono_negro": "icons/nodenegro.svg",
        "descripcion": "React, Vue, Angular, Express, Next.js, etc.",
        "exclude": ["node_modules/", "dist/", "build/", ".next/", ".nuxt/", "out/"],
        "install_cmd": "npm install",
        "package_files": ["package.json", "package-lock.json", "yarn.lock", "pnpm-lock.yaml"]
    },
    "python": {
        "nombre": "Python",
        "icono": "icons/pythonblanco.svg",
        "icono_negro": "icons/pythonnegro.svg",
        "descripcion": "Django, Flask, FastAPI, etc.",
        "exclude": ["venv/", "__pycache__/", "*.pyc", ".pytest_cache/", "env/", ".venv/"],
        "install_cmd": "pip install -r requirements.txt",
        "package_files": ["requirements.txt", "Pipfile", "pyproject.toml"]
    },
    "java_maven": {
        "nombre": "Java / Maven",
        "icono": "icons/javablanco.svg",
        "icono_negro": "icons/javanegro.svg",
        "descripcion": "Proyectos Maven",
        "exclude": ["target/", ".m2/"],
    ...
    "java_gradle": {
        ...
        "icono": "icons/javablanco.svg",
        "icono_negro": "icons/javanegro.svg",
        "descripcion": "Proyectos Gradle",
        "exclude": ["build/", ".gradle/"],
        "install_cmd": "gradle build",
        "package_files": ["build.gradle", "settings.gradle"]
    },
    "php": {
        "nombre": "PHP / Composer",
        "icono": "icons/jsblanco.svg",
        "icono_negro": "icons/jsnegro.svg",
        "descripcion": "Laravel, Symfony, etc.",
        "exclude": ["vendor/"],
    ...
    "ruby": {
        "nombre": "Ruby / Bundler",
        "icono": "icons/kotlinblanco.svg",
        "icono_negro": "icons/kotlinnegro.svg",
        "descripcion": "Rails, Sinatra, etc.",
        "exclude": ["vendor/bundle/"],
        "install_cmd": "bundle install",
        "package_files": ["Gemfile", "Gemfile.lock"]
    },
    "dotnet": {
        "nombre": ".NET / NuGet",
        "icono": "icons/c#blanco.svg",
        "icono_negro": "icons/c#negro.svg",
        "descripcion": "ASP.NET, Blazor, etc.",
    ...
    "go": {
        "nombre": "Go",
        "icono": "icons/goblanco.svg",
        "icono_negro": "icons/gonegro.svg",
        "descripcion": "Proyectos Go",
        "exclude": ["vendor/"],
...
class CronuxGUI:
    def __init__(self, page: ft.Page):
        ...
        # Intentar cargar el icono de la app (priorizar SVG)
        try:
        ...
        # Referencia al updater de iconos del wizard (para cambio de tema dinámico)
        self.wizard_icon_updater = None
    ...
    def cambiar_tema(self):
        ...
        # Actualizar iconos del wizard si está abierto
        if hasattr(self, 'wizard_icon_updater') and self.wizard_icon_updater:
            self.wizard_icon_updater()
    ...
    def crear_item_proyecto(self, proyecto):
        ...
        # Iconos específicos por tipo de software
        iconos_software = {
            "nodejs": "⬢",
            "python": "🐍",
            "java_maven": "☕",
        ...
        # Determinar si es un tipo de software específico o categoría general
        if tipo_proyecto in iconos_software:
            icono_display = ft.Text(
                iconos_software[tipo_proyecto], 
                size=28,
                text_align=ft.TextAlign.CENTER,
            )
        elif tipo_proyecto in iconos_categoria:
            icono_display = ft.Text(
                iconos_categoria[tipo_proyecto], 
                size=28,
                text_align=ft.TextAlign.CENTER,
            )
        else:
            icono_display = ft.Icon(ft.Icons.FOLDER, size=28, color=Colors.ACCENT_PRIMARY)
    ...
    def dialogo_nuevo_proyecto(self):
        """Modal wizard mejorado con iconos PNG - 3 pasos"""
        paso_actual = {"valor": 1}
        categoria_seleccionada = {"key": "software", "nombre": "Software", "icono": "💻"}
        tipo_software_seleccionado = {"key": "nodejs", "nombre": "Node.js / JavaScript", "icono": "node.png"}
        ...
        error_container = ft.Container(
            content=ft.Row([
                ft.Icon(ft.Icons.WARNING_ROUNDED, size=16, color=Colors.ACCENT_DANGER),
                ft.Container(width=8),
                ft.Text("", size=13, color=Colors.TEXT_PRIMARY, weight=ft.FontWeight.W_500),
            ], spacing=0, tight=True),
            bgcolor=Colors.DANGER_BG,
        ...
        ruta_texto = ft.Text(
            ...
            weight=ft.FontWeight.W_400, italic=True,
            max_lines=1, overflow=ft.TextOverflow.ELLIPSIS,
        )
        
        # Categorías generales (usando iconos de Flet)
        categorias = [
            ...
            {"nombre": "Tareas", "icono": ft.Icons.CHECK_CIRCLE, "key": "tareas"},
            {"nombre": "Investigación", "icono": ft.Icons.SCIENCE, "key": "investigacion"},
            {"nombre": "Diseño", "icono": ft.Icons.PALETTE, "key": "diseno"},
        ]
        
        # Tipos de software usando TIPOS_PROYECTO
        tipos_software = [
            {"nombre": TIPOS_PROYECTO["nodejs"]["nombre"], "icono": TIPOS_PROYECTO["nodejs"]["icono"], "icono_negro": TIPOS_PROYECTO["nodejs"]["icono_negro"], "key": "nodejs"},
            {"nombre": TIPOS_PROYECTO["python"]["nombre"], "icono": TIPOS_PROYECTO["python"]["icono"], "icono_negro": TIPOS_PROYECTO["python"]["icono_negro"], "key": "python"},
            {"nombre": TIPOS_PROYECTO["java_maven"]["nombre"], "icono": TIPOS_PROYECTO["java_maven"]["icono"], "icono_negro": TIPOS_PROYECTO["java_maven"]["icono_negro"], "key": "java_maven"},
            {"nombre": TIPOS_PROYECTO["java_gradle"]["nombre"], "icono": TIPOS_PROYECTO["java_gradle"]["icono"], "icono_negro": TIPOS_PROYECTO["java_gradle"]["icono_negro"], "key": "java_gradle"},
            {"nombre": TIPOS_PROYECTO["php"]["nombre"], "icono": TIPOS_PROYECTO["php"]["icono"], "icono_negro": TIPOS_PROYECTO["php"]["icono_negro"], "key": "php"},
            {"nombre": TIPOS_PROYECTO["ruby"]["nombre"], "icono": TIPOS_PROYECTO["ruby"]["icono"], "icono_negro": TIPOS_PROYECTO["ruby"]["icono_negro"], "key": "ruby"},
            {"nombre": TIPOS_PROYECTO["dotnet"]["nombre"], "icono": TIPOS_PROYECTO["dotnet"]["icono"], "icono_negro": TIPOS_PROYECTO["dotnet"]["icono_negro"], "key": "dotnet"},
            {"nombre": TIPOS_PROYECTO["go"]["nombre"], "icono": TIPOS_PROYECTO["go"]["icono"], "icono_negro": TIPOS_PROYECTO["go"]["icono_negro"], "key": "go"},
            {"nombre": TIPOS_PROYECTO["general"]["nombre"], "icono": TIPOS_PROYECTO["general"]["icono"], "icono_negro": TIPOS_PROYECTO["general"]["icono_negro"], "key": "general"},
        ]
        ...
        def seleccionar_categoria(cat_info):
            categoria_seleccionada.update(cat_info)
            for i, cat_data in enumerate(categorias):
                es_sel = cat_data["key"] == cat_info["key"]
                tarjetas_categoria[i].bgcolor = Colors.ACCENT_PRIMARY if es_sel else Colors.BG_PRIMARY
                tarjetas_categoria[i].border = ft.Border.all(2 if es_sel else 1, Colors.ACCENT_PRIMARY if es_sel else Colors.BORDER_DEFAULT)
                # Actualizar color del texto
                if len(tarjetas_categoria[i].content.controls) > 2:
                    tarjetas_categoria[i].content.controls[2].color = ft.Colors.WHITE if es_sel else Colors.TEXT_PRIMARY
                tarjetas_categoria[i].update()
        
        def seleccionar_tipo_software(tipo_info):
            tipo_software_seleccionado.update(tipo_info)
            actualizar_iconos_software()
        
        def actualizar_iconos_software():
            """Actualiza todos los iconos de software según selección y tema"""
            for i, tipo_data in enumerate(tipos_software):
                es_sel = tipo_data["key"] == tipo_software_seleccionado["key"]
                tarjetas_software[i].bgcolor = Colors.ACCENT_PRIMARY if es_sel else Colors.BG_PRIMARY
                tarjetas_software[i].border = ft.Border.all(2 if es_sel else 1, Colors.ACCENT_PRIMARY if es_sel else Colors.BORDER_DEFAULT)
                
                # Cambiar icono dinámicamente según selección y tema
                if es_sel:
                    # Seleccionado: siempre blanco (contrasta con fondo rojo)
                    icono_a_usar = tipo_data["icono"]
                else:
                    # No seleccionado: blanco en modo oscuro, negro en modo claro
                    is_dark = self.page.theme_mode == ft.ThemeMode.DARK
                    icono_a_usar = tipo_data["icono"] if is_dark else tipo_data["icono_negro"]
                
                tarjetas_software[i].content.controls[0].src = icono_a_usar
                
                # Actualizar color del texto
                if len(tarjetas_software[i].content.controls) > 2:
                    tarjetas_software[i].content.controls[2].color = ft.Colors.WHITE if es_sel else Colors.TEXT_PRIMARY
                tarjetas_software[i].update()
        
        # Crear tarjetas de categoría (con emojis más compactas)
        for cat_info in categorias:
            es_sel = cat_info["key"] == "software"
            tarjeta = ft.Container(
                content=ft.Column([
                    ft.Icon(cat_info["icono"], size=40, color=Colors.TEXT_PRIMARY),
                    ft.Container(height=8),
                    ft.Text(cat_info["nombre"], size=13, weight=ft.FontWeight.W_500,
                           color=ft.Colors.WHITE if es_sel else Colors.TEXT_PRIMARY,
                           text_align=ft.TextAlign.CENTER),
                ], horizontal_alignment=ft.CrossAxisAlignment.CENTER, spacing=0),
                bgcolor=Colors.ACCENT_PRIMARY if es_sel else Colors.BG_PRIMARY,
                padding=ft.Padding.all(16),
                border_radius=12,
                border=ft.Border.all(2 if es_sel else 1, Colors.ACCENT_PRIMARY if es_sel else Colors.BORDER_DEFAULT),
                on_click=lambda _, c=cat_info: seleccionar_categoria(c),
                ink=True, expand=True,
            )
            tarjetas_categoria.append(tarjeta)
        
        # Crear tarjetas de software (con iconos dinámicos según tema)
        for tipo_info in tipos_software:
            es_sel = tipo_info["key"] == "nodejs"
            # Determinar icono inicial según selección y tema
            if es_sel:
                # Seleccionado: siempre blanco
                icono_inicial = tipo_info["icono"]
            else:
                # No seleccionado: blanco en modo oscuro, negro en modo claro
                is_dark = self.page.theme_mode == ft.ThemeMode.DARK
                icono_inicial = tipo_info["icono"] if is_dark else tipo_info["icono_negro"]
            ...
            tarjeta = ft.Container(
                content=ft.Column([
                    ft.Image(
                        ...
                        width=40, 
                        height=40,
                        error_content=ft.Text("❌", size=20, color=ft.Colors.RED)
                    ),
                    ft.Container(height=8),
                    ft.Text(tipo_info["nombre"], size=12, weight=ft.FontWeight.W_500,
                           color=ft.Colors.WHITE if es_sel else Colors.TEXT_PRIMARY,
                           text_align=ft.TextAlign.CENTER),
                ], horizontal_alignment=ft.CrossAxisAlignment.CENTER, spacing=0),
                bgcolor=Colors.ACCENT_PRIMARY if es_sel else Colors.BG_PRIMARY,
                ...
                border_radius=12,
                border=ft.Border.all(2 if es_sel else 1, Colors.ACCENT_PRIMARY if es_sel else Colors.BORDER_DEFAULT),
                on_click=lambda _, t=tipo_info: seleccionar_tipo_software(t),
                ink=True, expand=True,
            )
            tarjetas_software.append(tarjeta)
        
        def seleccionar_carpeta_zenity(e):
            try:
                self.page.window_minimized = True
                self.page.update()
                result = subprocess.run(['zenity', '--file-selection', '--directory', '--title=Seleccionar carpeta', '--modal'],
                ...
                self.mostrar_snackbar("Instala 'zenity': sudo apt install zenity", error=True)
            except Exception as ex:
                print(f"Error: {ex}")
        ...
        paso3_container = ft.Container(visible=False)
        
        def actualizar_vista_paso(actualizar_ui=True):
            if paso_actual["valor"] == 1:
                # Paso 1: Categoría (sin header de botones)
                paso1_container.content = ft.Column([
                    ft.Text("¿Qué tipo de proyecto es?", size=22, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY),
                    ft.Container(height=24),
                    ft.Row([tarjetas_categoria[0], ft.Container(width=10), tarjetas_categoria[1], ft.Container(width=10), tarjetas_categoria[2]], expand=True),
                    ft.Container(height=10),
                    ft.Row([tarjetas_categoria[3], ft.Container(width=10), tarjetas_categoria[4], ft.Container(width=10), tarjetas_categoria[5]], expand=True),
                    ft.Container(height=24),
                    # Botón siguiente
                    ft.Row([
                        ft.Container(expand=True),
                        ft.Container(
                            content=ft.Row([
                                ft.Text("Siguiente", size=14, color=ft.Colors.WHITE, weight=ft.FontWeight.W_500),
                                ft.Icon(ft.Icons.ARROW_FORWARD, size=18, color=ft.Colors.WHITE),
                            ], spacing=8),
                            bgcolor=Colors.ACCENT_PRIMARY,
                            padding=ft.Padding.symmetric(horizontal=24, vertical=12),
                            border_radius=10,
                            on_click=lambda _: ir_siguiente_desde_paso1(),
                            ink=True,
                        ),
                    ]),
                ], spacing=0, tight=True)
                ...
                paso3_container.visible = False
            
            elif paso_actual["valor"] == 2:
                # Paso 2: Tipo de software
                paso2_container.content = ft.Column([
                    ft.Row([
                        ft.Column([
                            ft.Text("Paso 2 de 3", size=12, color=Colors.TEXT_MUTED, weight=ft.FontWeight.W_400),
                            ft.Container(height=6),
                            ft.Text("Selecciona el lenguaje", size=22, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY),
                        ], spacing=0, expand=True),
                        ft.Row([
                            ft.Container(
                                content=ft.Icon(ft.Icons.ARROW_BACK_ROUNDED, color=Colors.TEXT_PRIMARY, size=22),
                                bgcolor=Colors.BG_TERTIARY, padding=10, border_radius=22,
                                on_click=lambda _: ir_paso_1(), ink=True, tooltip="Atrás",
                            ),
                            ft.Container(width=10),
                            ft.Container(
                                content=ft.Icon(ft.Icons.ARROW_FORWARD_ROUNDED, color=ft.Colors.WHITE, size=22),
                                bgcolor=Colors.ACCENT_PRIMARY, padding=10, border_radius=22,
                                on_click=lambda _: ir_paso_3(), ink=True, tooltip="Siguiente",
                    ...
                    ft.Container(height=20),
                    ft.Row([tarjetas_software[0], ft.Container(width=10), tarjetas_software[1], ft.Container(width=10), tarjetas_software[2]], expand=True),
                    ft.Container(height=8),
                    ft.Row([tarjetas_software[3], ft.Container(width=10), tarjetas_software[4], ft.Container(width=10), tarjetas_software[5]], expand=True),
                    ft.Container(height=8),
                    ft.Row([tarjetas_software[6], ft.Container(width=10), tarjetas_software[7], ft.Container(width=10), tarjetas_software[8]], expand=True),
                ], spacing=0, tight=True)
                ...
                # Paso 3: Detalles
                tipo_final = tipo_software_seleccionado if categoria_seleccionada["key"] == "software" else categoria_seleccionada
                
                # Icono para el paso 3
                tipo_final = tipo_software_seleccionado if categoria_seleccionada["key"] == "software" else categoria_seleccionada
                icono_final = ft.Image(src=tipo_final.get("icono", "icons/wordblanco.svg"), width=28, height=28)
                
                paso3_container.content = ft.Column([
                    ft.Row([
                        ft.Column([
                            ft.Text("Paso 3 de 3" if categoria_seleccionada["key"] == "software" else "Paso 2 de 2",
                                   size=13, color=Colors.TEXT_MUTED, weight=ft.FontWeight.W_400),
                            ft.Container(height=8),
                            ft.Row([
                                icono_final,
                                ft.Container(width=12),
                                ft.Text(f"{tipo_final['nombre']}", size=26, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY),
                            ], spacing=0),
                        ], spacing=0, expand=True),
                        ft.Row([
                            ft.Container(
                                content=ft.Icon(ft.Icons.ARROW_BACK_ROUNDED, color=Colors.TEXT_PRIMARY, size=24),
                                bgcolor=Colors.BG_TERTIARY, padding=12, border_radius=25,
                                on_click=lambda _: volver_desde_paso3(), ink=True, tooltip="Atrás",
                            ),
                            ft.Container(width=12),
                            ft.Container(
                                content=ft.Icon(ft.Icons.CHECK_ROUNDED, color=ft.Colors.WHITE, size=24),
                                bgcolor=Colors.ACCENT_PRIMARY, padding=12, border_radius=25,
                                on_click=lambda _: crear_proyecto_handler(), ink=True, tooltip="Crear",
                    ...
                    ft.Text("Nombre del proyecto", size=14, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY),
                    ft.Container(height=12),
                    ...
                    ft.Row([
                        ft.Container(
                            content=ft.Row([
                                ...
                                ft.Text("Seleccionar ubicación", size=15, color=Colors.ACCENT_PRIMARY, weight=ft.FontWeight.W_600),
                    ...
                    ft.Container(height=12),
                    ft.Container(content=ruta_texto, padding=ft.Padding.symmetric(horizontal=4)),
                    ft.Container(expand=True),
                    error_container,
                ], spacing=0, tight=True)
                paso1_container.visible = False
                paso2_container.visible = False
                paso3_container.visible = True
            
            if actualizar_ui:
                paso1_container.update()
                paso2_container.update()
                paso3_container.update()
        
        def ir_siguiente_desde_paso1():
            if categoria_seleccionada["key"] == "software":
                paso_actual["valor"] = 2
            else:
                paso_actual["valor"] = 3
        ...
        def cerrar_modal():
            self.wizard_icon_updater = None  # Limpiar el updater
            modal.open = False
            self.page.update()
        
        # Contenedor para el loader de creación
        loader_creacion_content = ft.Column([], horizontal_alignment=ft.CrossAxisAlignment.CENTER, spacing=0)
        loader_creacion_container = ft.Container(
            content=loader_creacion_content,
            bgcolor=Colors.BG_SECONDARY,
            expand=True,
            visible=False,
        )
        progreso_creacion_texto = ft.Text("", size=13, color=Colors.TEXT_MUTED, text_align=ft.TextAlign.CENTER)
        
        def mostrar_loader_creacion(mensaje="Creando proyecto..."):
            loader_creacion_content.controls = [
                ft.Container(height=40),
                ft.ProgressRing(width=60, height=60, color=Colors.ACCENT_PRIMARY),
                ft.Container(height=20),
                ft.Text(mensaje, size=18, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY, text_align=ft.TextAlign.CENTER),
                ft.Container(height=12),
                progreso_creacion_texto,
            ]
            loader_creacion_container.visible = True
            self.page.update()
        
        def actualizar_progreso_creacion(texto):
            progreso_creacion_texto.value = texto
            self.page.update()
        
        def crear_proyecto_handler():
            nombre = nombre_field.value
            ruta = ruta_seleccionada["path"]
            tipo = tipo_software_seleccionado["key"] if categoria_seleccionada["key"] == "software" else categoria_seleccionada["key"]
            ...
            self.mostrar_loader_simple("Creando proyecto...")
            ...
            def ejecutar_creacion():
                ...
                try:
                    ...
                    # Callback dummy para evitar modo interactivo
                    def callback_dummy(msg):
                        pass
                    
                    # Crear proyecto con tipo
                    from crear_proyecto import crear_proyecto_cli
                    resultado = crear_proyecto_cli(nombre, tipo, callback_progreso=callback_dummy)
                    
                    if resultado:
                        # Agregar a la lista
                        self.agregar_proyecto(ruta, nombre, tipo)
                        self.mostrar_snackbar(f"✓ Proyecto '{nombre}' creado exitosamente")
                        self.mostrar_pantalla_inicio()
                    else:
                        self.mostrar_snackbar("Error al crear el proyecto", error=True)
                        self.mostrar_pantalla_inicio()
                except Exception as ex:
                    self.mostrar_snackbar(f"Error: {ex}", error=True)
                    self.mostrar_pantalla_inicio()
            
            # Ejecutar en thread separado
            import threading
            thread = threading.Thread(target=ejecutar_creacion, daemon=True)
            thread.start()
        
        # Inicializar vista
        actualizar_vista_paso(actualizar_ui=False)
        
        # Sidebar de progreso vertical
        def crear_sidebar_progreso():
            paso_num = paso_actual["valor"]
            total_pasos = 3 if categoria_seleccionada["key"] == "software" else 2
            
            # Definir los pasos
            pasos_info = [
                {"num": 1, "titulo": "Categoría", "icono": ft.Icons.CATEGORY_OUTLINED},
            ]
            
            if categoria_seleccionada["key"] == "software":
                pasos_info.append({"num": 2, "titulo": "Lenguaje", "icono": ft.Icons.CODE})
                pasos_info.append({"num": 3, "titulo": "Detalles", "icono": ft.Icons.EDIT_NOTE})
            else:
                pasos_info.append({"num": 2, "titulo": "Detalles", "icono": ft.Icons.EDIT_NOTE})
            
            items = []
            for i, info in enumerate(pasos_info):
                num = info["num"]
                es_actual = (num == paso_num)
                es_completado = (num < paso_num)
                es_pendiente = (num > paso_num)
                
                # Círculo del paso
                if es_completado:
                    circulo = ft.Container(
                        content=ft.Icon(ft.Icons.CHECK_ROUNDED, size=18, color=ft.Colors.WHITE),
                        width=40, height=40,
                        border_radius=20,
                        bgcolor=Colors.ACCENT_SUCCESS,
                        alignment=ft.alignment.Alignment(0, 0),
                    )
                    color_texto = Colors.ACCENT_SUCCESS
                elif es_actual:
                    circulo = ft.Container(
                        content=ft.Text(str(num), size=16, weight=ft.FontWeight.W_700, color=ft.Colors.WHITE),
                        width=40, height=40,
                        border_radius=20,
                        bgcolor=Colors.ACCENT_PRIMARY,
                        alignment=ft.alignment.Alignment(0, 0),
                    ...
                    color_texto = Colors.ACCENT_PRIMARY
                else:
                    circulo = ft.Container(
                        content=ft.Text(str(num), size=16, color=Colors.TEXT_MUTED),
                        width=40, height=40,
                        border_radius=20,
                        border=ft.Border.all(2, Colors.BORDER_DEFAULT),
                        bgcolor=Colors.BG_PRIMARY,
                        alignment=ft.alignment.Alignment(0, 0),
                    )
                    color_texto = Colors.TEXT_MUTED
                ...
                item = ft.Row([
                    ...
                    ft.Column([
                        ft.Text(
                            info["titulo"],
                            size=14,
                            weight=ft.FontWeight.W_600 if es_actual else ft.FontWeight.W_500,
                            color=color_texto,
                        ),
                        ft.Text(
                            f"Paso {num}",
                            size=11,
                            color=Colors.TEXT_MUTED,
                        ) if not es_actual else ft.Container(),
                    ], spacing=2),
                ], spacing=0)
                ...
                if i < len(pasos_info) - 1:
                    linea = ft.Container(
                        width=2,
                        height=32,
                        bgcolor=Colors.ACCENT_SUCCESS if es_completado else Colors.BORDER_DEFAULT,
                        margin=ft.Margin.only(left=19, top=4, bottom=4),
                    )
                    items.append(linea)
        ...
        sidebar_container = ft.Container(
            content=crear_sidebar_progreso(),
        ...
        def actualizar_sidebar():
            sidebar_container.content = crear_sidebar_progreso()
            sidebar_container.update()
        
        # Contenedor de contenido con animación de slide
        content_container = ft.Container(
            content=ft.Stack([paso1_container, paso2_container, paso3_container]),
            padding=ft.Padding.all(28),
            expand=True,
        ...
        # Modificar las funciones de navegación para actualizar sidebar y animar
        _ir_siguiente_original = ir_siguiente_desde_paso1
        _ir_paso_1_original = ir_paso_1
        _ir_paso_3_original = ir_paso_3
        _volver_paso3_original = volver_desde_paso3
        
        def ir_siguiente_desde_paso1():
            # Animación de salida
            content_container.opacity = 0.5
            content_container.offset = ft.Offset(-0.05, 0)
            content_container.update()
            import time
            time.sleep(0.15)
            
            _ir_siguiente_original()
            actualizar_sidebar()
            ...
            content_container.offset = ft.Offset(0, 0)
            content_container.update()
        ...
        # Modal con sidebar lateral y contenido
        modal_content = ft.Container(
            content=ft.Column([
                # Header compacto
                ft.Container(
                    content=ft.Row([
                        ft.Text("✨ Crear Proyecto", size=18, weight=ft.FontWeight.W_700, color=Colors.TEXT_PRIMARY),
                        ft.Container(expand=True),
                        ft.IconButton(
                ...
                # Layout: Sidebar + Contenido (o Loader)
                ft.Stack([
                    # Contenido normal
                    ft.Container(
                        content=ft.Row([
                    ...
                    # Loader superpuesto (solo visible cuando se activa)
                    loader_creacion_container,
                ], expand=True),
            ], spacing=0, tight=True),
            bgcolor=Colors.BG_SECONDARY,
            border_radius=20,
            ...
            animate_scale=ft.Animation(450, ft.AnimationCurve.EASE_OUT_CUBIC),
        ...
        # Registrar función para actualizar iconos cuando cambie el tema
        self.wizard_icon_updater = actualizar_iconos_software
        ...
        import time
        time.sleep(0.05)
        modal_content.scale = 1
        modal_content.opacity = 1
        self.page.update()

    def abrir_carpeta_existente(self):
        try:
            # Minimizar la ventana de Flet temporalmente para que zenity aparezca al frente
            self.page.window_minimized = True
            self.page.update()
            
            result = subprocess.run(
                ['zenity', '--file-selection', '--directory', '--title=Seleccionar proyecto Cronux', '--modal'],
                capture_output=True,
                text=True
            )
            
            # Restaurar la ventana de Flet
            self.page.window_minimized = False
            self.page.update()
    ...
    def dialogo_guardar_version(self):
        """Modal para guardar nueva versión con loader"""
        ...
        loader_container = ft.Container(visible=False)
        progreso_texto = ft.Text("", size=13, color=Colors.TEXT_MUTED, text_align=ft.TextAlign.CENTER)
        
        def mostrar_loader(mensaje="Guardando versión..."):
            loader_container.content = ft.Column([
                ft.Container(height=20),
                ft.ProgressRing(width=50, height=50, color=Colors.ACCENT_PRIMARY),
                ft.Container(height=16),
                ft.Text(mensaje, size=16, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY, text_align=ft.TextAlign.CENTER),
                ft.Container(height=8),
                progreso_texto,
            ], horizontal_alignment=ft.CrossAxisAlignment.CENTER, spacing=0)
        ...
        def actualizar_progreso(texto):
            progreso_texto.value = texto
            self.page.update()
        
        async def guardar_handler(e):
            ...
            # Obtener el número de versión que se va a crear
            from funcion_verficar import determinar_numero_version
            os.chdir(self.proyecto_actual)
            numero_version_nueva = determinar_numero_version()
            
            # Mostrar loader simple
            self.mostrar_loader_simple(f"Guardando versión {numero_version_nueva}...")
            
            try:
                # Usar la función CLI con callback dummy
                ...
                with concurrent.futures.ThreadPoolExecutor() as executor:
                    future = executor.submit(
                        guardar_version_cli,
                        mensaje,
                        callback_dummy  # Callback dummy
                    )
                    resultado = future.result()
                
                if resultado:
                    # Actualizar versión actual
                    self.version_actual = numero_version_nueva
                    
                    self.mostrar_snackbar(f"✓ Versión {self.version_actual} guardada correctamente")
                    self.mostrar_vista_proyecto()
                else:
                    self.mostrar_snackbar("Error al guardar la versión", error=True)
                    self.mostrar_vista_proyecto()
            except Exception as ex:
                self.mostrar_snackbar(f"Error: {ex}", error=True)
                self.mostrar_vista_proyecto()
            ...
            content=ft.Column([
                ...
                ft.Container(
                    content=ft.Row([
                        ...
                        ft.Text("Se aplicarán exclusiones inteligentes según el tipo de proyecto", 
                               size=13, 
                               color=Colors.TEXT_PRIMARY,
                               weight=ft.FontWeight.W_400),
                    ], spacing=10),
    ...
    def confirmar_restaurar(self, version):
        """Modal para confirmar restauración de versión con auto-instalación"""
        
        # Contenedor para el loader
        loader_container = ft.Container(visible=False)
        progreso_texto = ft.Text("", size=13, color=Colors.TEXT_MUTED, text_align=ft.TextAlign.CENTER)
        
        def mostrar_loader(mensaje="Restaurando versión..."):
            loader_container.content = ft.Column([
                ft.Container(height=20),
                ft.ProgressRing(width=50, height=50, color=Colors.ACCENT_PRIMARY),
                ft.Container(height=16),
        ...
        def restaurar_handler(e):
            ...
            # Mostrar loader simple
            self.mostrar_loader_simple(f"Volviendo a versión {version['version']}...")
            ...
            def ejecutar_restauracion():
                try:
                    ...
                    # Usar la función CLI SIN auto-instalación pero CON callback para evitar confirmación
                    from restaurar_versiones import restaurar_version_cli
                    resultado = restaurar_version_cli(
                        str(version['version']), 
                        auto_instalar=False,  # NUNCA instalar automáticamente
                        callback_progreso=callback_dummy  # Callback dummy para evitar modo interactivo
                    )
                    
                    if resultado:
                        # Actualizar versión actual
                        self.version_actual = version['version']
                        
                        # Mostrar mensaje según el tipo de proyecto
                        try:
                            with open(os.path.join(self.proyecto_actual, ".cronux", "proyecto.json"), "r") as f:
                                datos_proyecto = json.load(f)
                                tipo_proyecto = datos_proyecto.get("tipo", "general")
                                
                                if tipo_proyecto == "nodejs":
                                    self.mostrar_snackbar(f"✓ Versión {version['version']} restaurada. Ejecuta: npm install && npm start")
                                elif tipo_proyecto == "python":
                                    self.mostrar_snackbar(f"✓ Versión {version['version']} restaurada. Ejecuta: pip install -r requirements.txt")
                                else:
                                    self.mostrar_snackbar(f"✓ Versión {version['version']} restaurada correctamente")
                        except:
                            self.mostrar_snackbar(f"✓ Versión {version['version']} restaurada correctamente")
                        
                        self.mostrar_vista_proyecto()
                    else:
                        self.mostrar_snackbar("Error al restaurar la versión", error=True)
                        self.mostrar_vista_proyecto()
                except Exception as ex:
                    print(f"Error en restauración: {ex}")
                    import traceback
                    traceback.print_exc()
                    self.mostrar_snackbar(f"Error: {ex}", error=True)
                    self.mostrar_vista_proyecto()
            ...
            # Iniciar hilo
            thread = threading.Thread(target=ejecutar_restauracion, daemon=True)
            thread.start()
        ...
        form_container = ft.Container(
            content=ft.Column([
                ...
                ft.Text("Restaurar versión", 
                    ...
                    ft.Container(
                        content=ft.Row([
                            ft.Icon(ft.Icons.WARNING_ROUNDED, size=14, color=Colors.ACCENT_SECONDARY),
                    ...
                    ft.Container(
                        content=ft.Column([
                            ft.Row([
                                ft.Text("Fecha:", size=12, color=Colors.TEXT_SECONDARY, weight=ft.FontWeight.W_600),
                                ft.Text(version['fecha'], size=12, color=Colors.TEXT_PRIMARY),
                            ], spacing=6),
                            ft.Container(height=4),
                            ft.Text(version['mensaje'], size=12, color=Colors.TEXT_PRIMARY, max_lines=2, overflow=ft.TextOverflow.ELLIPSIS),
                        ], spacing=0),
                        bgcolor=Colors.BG_PRIMARY,
                        padding=ft.Padding.all(10),
                        border_radius=8,
        ...
        modal = ft.BottomSheet(
            content=ft.Container(
                ...
                bgcolor=Colors.BG_SECONDARY,
                border_radius=ft.BorderRadius.only(top_left=20, top_right=20),
                height=380,  # Reducido porque quitamos los checkboxes
            ),
            open=True,
        )
        self.page.overlay.append(modal)
    ...
    def mostrar_loader_simple(self, mensaje="Cargando..."):
        """Muestra un loader simple y centrado"""
        self.page.controls.clear()
        self.page.add(
            ft.Container(
                content=ft.Column([
    ...
    def mostrar_loader_pantalla_completa(self, mensaje="Cargando..."):
        """Muestra un loader de pantalla completa con mensaje de progreso y log tipo terminal"""
        self.loader_mensaje = ft.Text(mensaje, size=18, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY, text_align=ft.TextAlign.CENTER)
        self.loader_log_lines = []
        self.loader_log_column = ft.Column(
            controls=[],
            spacing=2,
            scroll=ft.ScrollMode.AUTO,
            height=300,
        ...
        self.page.add(
            ft.Container(
                content=ft.Column([
                    ...
                    ft.Container(
                        content=ft.Column([
                            ft.Text("📋 Log de operación:", size=14, weight=ft.FontWeight.W_600, color=Colors.TEXT_PRIMARY),
                            ft.Container(height=8),
                            ft.Container(
                                content=self.loader_log_column,
    ...
    def actualizar_progreso_loader(self, texto):
        """Actualiza el texto de progreso del loader agregando líneas al log"""
        if hasattr(self, 'loader_mensaje'):
            # Agregar línea al log
            if hasattr(self, 'loader_log_column'):
                # Limitar a las últimas 20 líneas
                if len(self.loader_log_lines) >= 20:
                    self.loader_log_lines.pop(0)
                    self.loader_log_column.controls.pop(0)
                
                self.loader_log_lines.append(texto)
                ...
                elif texto.startswith("Ejecutando:"):
                    color = ft.Colors.YELLOW_400
                else:
                    color = ft.Colors.WHITE70
                
                self.loader_log_column.controls.append(
                    ft.Text(
                        f"$ {texto}",
                        size=12,
                        color=color,
                ...
                # Auto-scroll al final (sin await ya que no es async)
                try:
                    self.loader_log_column.scroll_to(offset=-1, duration=100)
                except:
                    pass  # Ignorar si falla el scroll
                
            self.page.update()
    
    def ocultar_loader_pantalla_completa(self):
        """Oculta el loader de pantalla completa"""
        # No hace nada, la siguiente vista reemplazará el contenido
        pass
    ...
    def exportar_proyecto(self):
        ...
        try:
            ...
            # Usar zenity para seleccionar ubicación
            self.page.window_minimized = True
            self.page.update()
            
            result = subprocess.run(
                ['zenity', '--file-selection', '--save', '--filename=' + nombre_zip, '--title=Guardar exportación', '--modal'],
                capture_output=True,
                text=True
            )
    ...
    def importar_proyecto(self):
        ...
        try:
            ...
            result = subprocess.run(
                ['zenity', '--file-selection', '--file-filter=Archivos ZIP | *.zip', '--title=Seleccionar proyecto ZIP', '--modal'],
                capture_output=True,
                text=True
            )
            ...
            archivo_zip = result.stdout.strip()
            ...
            result = subprocess.run(
                ['zenity', '--file-selection', '--directory', '--title=Seleccionar carpeta de destino', '--modal'],
                capture_output=True,
                text=True
            )
            ...
            carpeta_destino = Path(result.stdout.strip())
...
def main(page: ft.Page):
    # Registrar directorio de assets con ruta absoluta
    import os
    from pathlib import Path
    script_dir = Path(__file__).parent
    assets_path = str(script_dir / "assets")
    page.assets_dir = assets_path
    
    print("="*60)
    print("DEBUG: Configuración de Assets")
    print("="*60)
    print(f"Script directory: {script_dir}")
    print(f"Assets directory: {assets_path}")
    print(f"Assets exists: {Path(assets_path).exists()}")
    
    # Listar archivos en assets
    if Path(assets_path).exists():
        print("\nArchivos en assets:")
        for file in Path(assets_path).iterdir():
            print(f"  - {file.name}")
